...
* Invokes the scaling policy periodically based on the user-defined `policy_interval` and `warm_up_time` in [ds2.toml](https://github.com/strymon-system/ds2/blob/master/controller/config/ds2.toml)
